...
@section('content')
      ...
      <div class="col-sm-12 col-xl-15">
        <div class=".bg-secondary.bg-gradient rounded h-100 p-4">
            <h6 class="mb-4">Cập nhập nhân viên</h6>
            <form action="/staff/updateStaff/{{$staff->id}}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" name="username" id="floatingInput" value="{{$staff->username}}">
            ...
            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Cập nhật nhân viên</button>                     
        </form>
        <form action="/staff/changePass" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="form-floating mb-3">
            <input type="password" class="form-control" name="password" id="floatingInput" value="">
        ...
        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Cấp lại mật khẩu</button> 
        </div>
    </div>
@stop
@section('navbar')
